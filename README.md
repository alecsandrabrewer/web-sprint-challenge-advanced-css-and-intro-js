...
Accessibility in a website is how well people with impairments can access and navigate around a website.

2. Talk about 3 different things you can do to ensure your website is accessible. 

Higher contrast between colors, larger text, and semantic html

3. How would you explain the concept of a variable to someone new to programming?

Variables are a way to store, change, and use data in code

4. What is the purpose of using functions in code?

Functions allow developers to perform action in code without having to constantly repeat the lines of code, they can just invoke it using the parameters set up.
